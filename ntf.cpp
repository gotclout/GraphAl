...
******************************************************************************/
  ...
  src = g6.VE.find(Vertex("A"));
  snk = g6.VE.find(Vertex("H"));
  EDMONDS_KARP(g6, src->first, snk->first);
  cout << "A\n" << g6 << ln;
  ...
  src = g7.VE.find(Vertex("A"));
  snk = g7.VE.find(Vertex("G"));
  EDMONDS_KARP(g7, src->first, snk->first);
  cout << "B\n" << g7 << ln;
  ...
  src = g8.VE.find(Vertex("A"));
  snk = g8.VE.find(Vertex("H"));
  EDMONDS_KARP(g8, src->first, snk->first);
  cout << "C\n" << g8 << ln;
  ...
  src = g9.VE.find(Vertex("A"));
  snk = g9.VE.find(Vertex("H"));
  EDMONDS_KARP(g9, src->first, snk->first);
  cout << "D\n" << g9 << ln;
